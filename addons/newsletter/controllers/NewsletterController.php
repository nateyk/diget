...
class NewsletterController extends Controller
{
    ...
    public function update(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'newsletter.api_key' => ['required_if:newsletter.status,on', 'nullable', 'string', 'max:150'],
            'newsletter.audience_id' => ['required_if:newsletter.status,on', 'nullable', 'string', 'max:150'],
        ]);
