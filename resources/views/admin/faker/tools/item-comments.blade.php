                ...
                <div class="row g-3">
                    <div class="col-12">
                        ...
                        <select name="item" class="form-select form-select-md selectpicker" title="--"
                            ...
                            @foreach (\App\Models\Item::approved()->get() as $item)
                    ...
                    <div class="col-12">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="with_author_reply" id="authorReply"
                                @checked(old('with_author_reply'))>
                            <label class="form-check-label" for="authorReply">{{ translate('With Author Reply') }}</label>
                        </div>
                    </div>
                    <div class="col-12">
