...
@section('title', translate('Buyer Taxes'))
@section('create', route('admin.financial.buyer-taxes.create'))
            ...
            <tbody>
                @foreach ($buyerTaxes as $tax)
                    <tr>
                        <td>{{ $tax->id }}</td>
                        <td>
                            <a href="{{ route('admin.financial.buyer-taxes.edit', $tax->id) }}" class="text-dark">
                                {{ $tax->name }}
                            </a>
                        </td>
                        <td>{{ $tax->rate }}%</td>
                                ...
                                <ul class="dropdown-menu dropdown-menu-sm-end" data-popper-placement="bottom-end">
                                    <li>
                                        <a class="dropdown-item"
                                            href="{{ route('admin.financial.buyer-taxes.edit', $tax->id) }}"><i
                                    ...
                                    <li>
                                        <form action="{{ route('admin.financial.buyer-taxes.destroy', $tax->id) }}"
                                            method="POST">
                                            @csrf @method('DELETE')
