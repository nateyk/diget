                        ...
                        <tbody>
                            @forelse ($tickets as $ticket)
                                <tr>
                                    ...
                                    <td class="text-start">
                                        <a href="{{ route('workspace.tickets.show', $ticket->id) }}" class="text-dark">
                            ...
                            @empty
                                @include('themes.basic.workspace.partials.table-empty-row', [
                                    'colspan' => 6,
                                    'message' => translate('No support tickets match the current filters.'),
                                ])
                            @endforelse
                        </tbody>
                    </table>
                ...
                <div class="py-4">
                    <div class="mb-4">
                        <svg xmlns="http://www.w3.org/2000/svg" width="180px" height="180px"
                            viewBox="0 0 648.36337 565.55088" xmlns:xlink="http://www.w3.org/1999/xlink">
                            <path
                                ...
                                transform="translate(-275.81831 -167.22456)"
                            ...
                            <path
                                ...
                                transform="translate(-275.81831 -167.22456)"
                                fill="{{ $themeSettings->colors->primary_color }}" />
                            <circle cx="431.77822" cy="249.16734" r="51"
                                fill="{{ $themeSettings->colors->primary_color }}" />
                            <path
